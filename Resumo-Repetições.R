...
# Na prática se der arredonda o número de repetições para cima!
# r = valor calculado.
...
#O resultado dessa diferença C) 3.3 > 1 = Sem convergência
...
#O resultado dessa diferença C) 0.2 < 1 = Convergiu 
